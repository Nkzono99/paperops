...
2. `template/AGENTS.md`、`template/CLAUDE.md`、`template/contracts/`、`template/workflow/`、`template/.claude/skills/`、`template/.agents/skills/`、`template/scripts/` はユーザー向けインターフェースとして扱う。
