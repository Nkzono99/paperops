...
`update-paperops` は `AGENTS.md`、`CLAUDE.md`、`Makefile`、`contracts/`、`workflow/`、`scripts/`、`.agents/`、`.claude/`、`.github/ISSUE_TEMPLATE/` などのハーネス管理面だけを扱う。原稿、notes、refs、カード層、`manuscript/writing-profile.yml` は下流固有内容として自動上書きしない。
