.PHONY: venv smoke cli-smoke scaffold-package-boundary-check lint-bib citation-check mirror-check mirror-freshness-check public-terms-check argument-focus-check claim-evidence-check paper-layer-card-check submission-drift-check skill-mirror-check links-check collect-context template-readiness-check
...
smoke: cli-smoke lint-bib citation-check mirror-check mirror-freshness-check public-terms-check argument-focus-check claim-evidence-check paper-layer-card-check submission-drift-check skill-mirror-check links-check collect-context template-readiness-check
