...
- [ ] `make ci` を実行した（参考文献、citation key、ミラー、公開語彙、claim-evidence、skill 対応、ビルド構造）
- [ ] 外部共有・投稿に近い変更の場合は `make pre-submit` を実行し、引用サマリー、`manuscript/publication-metadata.toml`、`notes/reproducibility.md`、submission slot / drift を確認した
