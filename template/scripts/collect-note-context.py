...
SECTIONS = [
    ...
    ("Session context", "notes/session-context.md"),
...
def render_context(root):
    lines = ["# Session Context Snapshot", ""]
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Collect core note context for session startup.")
