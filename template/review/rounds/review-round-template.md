...
| --- | --- | --- | --- | --- |
| story_architect / evidence_auditor / results_structure_reviewer / discussion_function_reviewer / figure_story_reviewer / public_reader / reviewer_panel / submission_hygienist | manuscript block / claim / figure / section | `review/rounds/subagent-report-*.md` | story_loop / evidence_loop / section_loop / prose_loop / submission_loop | accepted_to_feedback_card / accepted_to_claim_or_evidence_update / accepted_to_section_plan / deferred_with_reason / rejected_with_reason / requires_human_decision |
