...
argument-hint: "[artifact-or-goal]"
allowed-tools: Read, Edit, Write, Glob, Grep, Bash
---

# finalize-manuscript

Claude Code で使う互換入口。共通手順は `.agents/skills/finalize-manuscript/SKILL.md` を source of truth として読む。

@${CLAUDE_SKILL_DIR}/../../../.agents/skills/finalize-manuscript/SKILL.md
