...
このディレクトリは、人間と AI が共有する高次の構想ストーリーを置く場所である。

`_paperops/` の evidence card、claim card、workflow state、contract は AI とハーネスの内部作業台として扱う。人間は通常、ここで研究の読み筋を確認し、原稿やレビューコメントに戻ればよい。

## 主なファイル

- `story-seed.md`: 最初の構想、想定機構、必要な結果、外れた場合の分岐、結果との照合判断。
