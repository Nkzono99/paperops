...
- `review-public-manuscript` とは分けて使う。この skill は `notes/project-brief.md`、`notes/contribution-claims.md`、`manuscript/mirror/status.md`、JA source of truth を読んで、主張と証拠の階層を設計する。
