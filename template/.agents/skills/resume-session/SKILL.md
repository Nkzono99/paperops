...
- `notes/handoff.md`、`notes/todo.md`、`notes/open-questions.md`、`notes/project-brief.md`、`notes/related-work-map.md`、`notes/claim-evidence-map.md`、`notes/reviewer-model.md`、`notes/peer-review.md`、`manuscript/mirror/status.md` を優先して読む。
