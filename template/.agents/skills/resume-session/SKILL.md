...
4. scientific gate で止まっている claim、外部ソース到達、refs の未完了作業を指摘する。
5. ミラーのドリフト、refs の未完了作業、未解決の質問を指摘する。
6. 次の具体的な執筆ステップを提案する。
...
- `notes/handoff.md`、`notes/todo.md`、`notes/open-questions.md`、`notes/project-brief.md`、`notes/scientific-gate.md`、`notes/related-work-map.md`、`notes/source-reach.md`、`notes/claim-evidence-map.md`、`notes/reviewer-model.md`、`notes/peer-review.md`、`manuscript/mirror/status.md` を優先して読む。
