...
2. `notes/views/scientific-gate.md` で claim の gate status を確認する。`analysis-needed` や `assumption-blocked` の claim は、hedge だけで本文に通さず、必要な確認へ戻す。
3. hedge を分類する:
...
7. `claims/claims/` と `claims/gates/` の status、scope、limitation を必要に応じて更新し、`notes/views/claim-evidence-map.md` と `notes/views/scientific-gate.md` を俯瞰用に更新する。
...
- `claims/claims/`、`claims/gates/`、`notes/views/scientific-gate.md`、`notes/views/claim-evidence-map.md`、`notes/reviewer-model.md`、`manuscript/mirror/status.md` を先に読む。
