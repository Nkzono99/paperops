...
2. `notes/scientific-gate.md` で claim の gate status を確認する。`analysis-needed` や `assumption-blocked` の claim は、hedge だけで本文に通さず、必要な確認へ戻す。
3. hedge を分類する:
...
7. `notes/claim-evidence-map.md` と `notes/scientific-gate.md` の status、scope、limitation を必要に応じて更新する。
...
- `notes/scientific-gate.md`、`notes/claim-evidence-map.md`、`notes/reviewer-model.md`、`manuscript/mirror/status.md` を先に読む。
