...
`_paperops/notes/reviews/review-YYYY-MM-DD.md` は人間が最初から構造化して書く入力フォームではなく、`git diff` と TeX コメントから生成される作業台帳として扱う。
...
- `Review ledger`: 生成または更新した `_paperops/notes/reviews/review-YYYY-MM-DD.md`
