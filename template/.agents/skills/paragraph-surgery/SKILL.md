...
- concept-term compression: claim / argument / evidence card の意味を、強い英語名詞句へ単語化しすぎていないか確認する。必要なら `notes/views/concept-terms.md` に記録し、普通の文へほどく。
...
5. hyphen / slash compound や強い英語名詞句が多い場合は `notes/views/concept-terms.md` を更新し、accepted term か、普通の文へほどく語かを決める。
