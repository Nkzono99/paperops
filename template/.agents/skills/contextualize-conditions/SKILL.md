...
- denominator の意味を `notes/condition-context-map.md` と `notes/reproducibility.md` に残す。
...
- 過度な抽象化で overclaim しない。抽象化後の主張は `claim-evidence-map` の scope と limitation に接続する。
