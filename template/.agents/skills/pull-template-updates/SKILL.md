...
- `notes/project-brief.md`、`notes/contribution-claims.md`、`notes/related-work-map.md`、`notes/claim-evidence-map.md`、`notes/reviewer-model.md`、`notes/ai-use.md`、`manuscript/venue.md`、`manuscript/mirror/terminology.yml` はプロジェクト固有内容として扱う。
