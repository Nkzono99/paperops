...
5. 知見の更新があれば `notes/project-brief.md`、`notes/contribution-claims.md`、`claims/`、`evidence/`、`notes/views/scientific-gate.md`、`notes/related-work-map.md`、`notes/source-reach.md`、`notes/views/claim-evidence-map.md` も更新する。
6. 読者想定、投稿先、査読者の懸念が変わった場合は `notes/reviewer-model.md` を更新する。
7. 模擬査読、実査読コメント、response letter 方針が変わった場合は `review/` のカードと `notes/views/peer-review.md` を更新する。
...
- 中心主張の準備状態や人間承認が変わった場合は `claims/gates/` と `notes/views/scientific-gate.md` に残す。
