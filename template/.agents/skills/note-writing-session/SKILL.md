...
5. 知見の更新があれば `notes/project-brief.md`、`notes/contribution-claims.md`、`notes/related-work-map.md`、`notes/claim-evidence-map.md` も更新する。
...
8. AI が文献、解析、コード、図表、投稿文面、査読・返答案に関与した場合は `notes/ai-use.md` を更新する。
