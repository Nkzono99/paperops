...
- 編集前に `README.md`、`AGENTS.md`、`notes/project-brief.md`、`manuscript/venue.md`、`refs/local/locations.example.toml` を確認する。
- 初回セットアップ後、可能なら `make ci`、難しい場合は `make lint-bib` と `make mirror-check` を個別に実行する。
