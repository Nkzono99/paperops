...
source_of_truth:
  ...
  - _paperops/model/issues/writing/
authoritative_for:
  - overview
---
...
このファイルは `_paperops/model/issues/analysis/` と `_paperops/model/issues/writing/` のカードを人間が俯瞰するためのビューである。依頼の正本は request card に置く。
...
| --- | --- | --- | --- | --- | --- |
| WREQ-0001 | `_paperops/model/issues/writing/WREQ-0001.yml` | FB-0001 | 未記入 | CLM-0001 | draft |
