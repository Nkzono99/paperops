...
| --- | --- | --- | --- |
| SF-0001 | `_paperops/refs/summaries/` / `.bib` / `_paperops/evidence/sources/` / `_paperops/notes/related-work-map.md` / `_paperops/notes/views/scientific-gate.md` | 未記入 | open |
