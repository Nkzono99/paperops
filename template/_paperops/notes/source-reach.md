...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| SR-0001 | paper-metadata / github / web-page / video-transcript / rss-news / social-discussion / local-link | 未記入 | 未記入 | 未記入 | none / local-cookie / token / human-only | no-raw / ignored-raw / curated-only | `_paperops/notes/related-work-map.md` / `_paperops/refs/summaries/` / `_paperops/model/research/sources/` / `_paperops/notes/reproducibility.md` / `_paperops/notes/views/scientific-gate.md` | unsearched / found-unread / metadata-checked / read / cross-checked / not-usable |
...
| --- | --- | --- | --- |
| SF-0001 | `_paperops/refs/summaries/` / `.bib` / `_paperops/model/research/sources/` / `_paperops/notes/related-work-map.md` / `_paperops/notes/views/scientific-gate.md` | 未記入 | open |
